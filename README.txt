...
- сделать дублирование балансов как в бухучете А = П для лучшего контроля выплат и соответствия
- /после нажатия на кнопку опубликовать у модератора должна делаться запись в новой таблице KT-articul,
в таблицу wbpost добавить название артикула (не articul_wb, а просто)
- /balance и /payouts сделать вычеты на вывод и ведение баланса
